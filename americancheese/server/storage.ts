...
export interface IStorage {
  ...
  getTemplateCategories(): Promise<CategoryTemplate[]>;
  getTemplateCategory(id: number): Promise<CategoryTemplate | undefined>;
  getTemplateCategoriesByType(type: string): Promise<CategoryTemplate[]>;
  getTemplateCategoriesByParent(parentId: number): Promise<CategoryTemplate[]>;
  createTemplateCategory(category: InsertCategoryTemplate): Promise<CategoryTemplate>;
  updateTemplateCategory(id: number, category: Partial<InsertCategoryTemplate>): Promise<CategoryTemplate | undefined>;
  ...
  getChecklistItemComments(checklistItemId: number): Promise<ChecklistItemComment[]>;
...
export class MemStorage implements IStorage {
  ...
  async createLabor(labor: InsertLabor): Promise<Labor> {
    ...
    const newLabor: Labor = {
      ...
      subtaskId: labor.subtaskId ?? null,
      taskDescription: labor.taskDescription ?? null,
      workDescription: labor.workDescription ?? null,
