...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-md border border-slate-200 shdaow-sm">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b-slate-200", className)} {...props} />
))
