...
// Structural Framing tasks
const framingTasks: TaskTemplate[] = [
  {
    id: "FR1",
    title: "Plan Framing Materials and Labor – FR1",
    description: "Conduct bidding processes for framing materials and labor. Discuss framing requirements with crew, including special angles and custom materials. Order necessary special items and ensure temporary electric is available. (FR1, FR2, FR3, FR4)",
    tier1Category: "structural",
  ...
  {
    id: "FR5",
    title: "Prepare and Start Framing – FR5",
    description: "Order and receive initial lumber load. Prepare site with flat platform, chalk line layout, and install sill felt, sill plates, and support columns. (FR5, FR6, FR7, FR8)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR9",
    title: "Supervise and Frame First Floor – FR9",
    description: "Oversee daily framing work. Frame floor joists, subfloor, stairs, exterior walls, and insert large items. Plumb and align walls for accuracy. (FR9, FR10, FR11, FR12, FR13, FR14)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR15",
    title: "Frame Second Floor – FR15",
    description: "Frame second floor joists, subfloor, exterior walls, and insert large items. Plumb and align walls. Install ceiling joists and confirm window/door opening dimensions. (FR15, FR16, FR17, FR18, FR19)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR20",
    title: "Construct Roof Structure – FR20",
    description: "Frame roof using trusses or stick-built method. Install roof deck with staggered sheathing and ply clips. (FR20, FR21)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR22",
    title: "Review and Dry-in Structure – FR22",
    description: "Make first framing payment after reviewing items. Install tar paper to dry-in structure. Frame chimney chases and install fireplaces. (FR22, FR23, FR24, FR25)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR26",
    title: "Frame Architectural Features – FR26",
    description: "Frame dormers, skylights, tray ceilings, skylight shafts, and bay windows. (FR26, FR27)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR28",
    title: "Install and Inspect Wall Sheathing – FR28",
    description: "Apply and inspect exterior wall sheathing for gaps and punctures. (FR28, FR29)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR30",
    title: "Finish Exterior Framing – FR30",
    description: "Remove temporary bracing and install exterior windows and doors with proper waterproofing. Apply dead wood for drywall support. (FR30, FR31, FR32)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR33",
    title: "Install Roofing and Decks – FR33",
    description: "Install roof ventilators and pressure-treated framing for exterior decks. (FR33, FR34)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR35",
    title: "Inspect and Finalize Framing – FR35",
    description: "Conduct final framing inspection, schedule loan officer visit, and correct any outstanding framing issues. (FR35, FR36, FR37)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
  ...
  {
    id: "FR38",
    title: "Close Out Framing Contracts – FR38",
    description: "Pay framing labor and retainage after final inspection approval and signed affidavit. (FR38, FR39)",
    tier1Category: "structural",
    tier2Category: "framing",
    category: "framing",
    estimatedDuration: 2,
...
const plumbingTasks: TaskTemplate[] = [
  ...
  },
  {
    ...
    description: "Walk through the site with the plumber to confirm placement of plumbing systems and any special fixtures. Account for exterior finish (e.g., brick veneer), as this affects the extension of exterior faucets. Also, mark the location of all fixtures (sinks, tubs, showers, toilets, outdoor spigots, wet bars, icemakers, utility tubs, washers, and water heater). Note vanity vs. pedestal sinks, drain end of tubs, and wall/cabinet-mounted vs. floor-mounted toilets. (PL4, PL5)",
    tier1Category: "systems",
    tier2Category: "plumbing",
    category: "plumbing",
    estimatedDuration: 2,
...
const electricalTasks: TaskTemplate[] = [
  {
    ...
    description: "Determine electrical requirements by deciding where to place lighting fixtures, outlets, and switches. Make sure no switches are blocked by a door, and consider furniture placement. Even if your blueprint has an electrical diagram, verify or improve it. Investigate low voltage and fluorescent lighting, keeping in mind that fluorescent lights cannot be dimmed. Select electrical fixtures and appliances by visiting lighting showrooms, verifying price/quality options, confirming outlet requirements (220 volt vs 110 volt), locating ceiling fans, and testing lighting layouts. Secure lighting catalogs for reference. Conduct a standard bidding process by comparing rates, determining if fixture costs are within contract scope, checking HVAC connections, verifying electrician licenses, requesting bids in writing, and checking references. (EL1, EL2, EL4)",
    tier1Category: "systems",
...
const sidingTasks: TaskTemplate[] = [
  {
    id: "SC1",
...
const insulationTasks: TaskTemplate[] = [
  {
    id: "IN1",
...
const flooringTasks: TaskTemplate[] = [
  ...
  {
    id: "FL17",
    title: "Prepare and Order Carpeting – FL17",
    description: "Verify carpet requirements and specs, finalize colors, and order all necessary materials. Allow time for delivery. (FL17, FL18)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL19",
    title: "Install Carpet Pad and Flooring – FL19",
    description: "Install tack strips, seal concrete if needed, lay foam or rubber padding, and install carpeting with minimal seams. (FL19, FL20, FL21)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL22",
    title: "Finish Carpet Installation and Cleanup – FL22",
    description: "Stretch carpet for smooth surface, install metal doorway strips, and vacuum thoroughly. (FL22, FL23, FL24)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL25",
    title: "Inspect and Finalize Carpet Installation – FL25",
    description: "Inspect carpet work, correct issues, and pay carpet installer. Get signed affidavit and pay retainage after confirming quality. (FL25, FL26, FL27, FL28)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL29",
    title: "Order and Prepare for Hardwood Installation – FL29",
    description: "Order hardwood in advance to allow acclimation to home humidity. Clean and inspect subfloor. (FL29, FL30, FL31)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL32",
    title: "Install and Finish Hardwood Flooring – FL32",
    description: "Install flooring perpendicular to floor joists, sand smooth, apply stain if desired, and add polyurethane protective coating. (FL32, FL33, FL34, FL35)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL36",
    title: "Complete Hardwood Floor Finishing – FL36",
    description: "Apply final protective coating, install thresholds, and allow sufficient drying time. (FL36, FL37, FL38)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL39",
    title: "Inspect and Finalize Hardwood Installation – FL39",
    description: "Inspect hardwood floors for smoothness and appearance, make any corrections, and finalize contractor payment with signed affidavit. (FL39, FL40, FL41)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL42",
    title: "Order and Prepare for Vinyl Installation – FL42",
    description: "Order vinyl flooring with pattern matching in mind, prep subfloor with luan underlayment, and remove fixtures/trim as needed. (FL42, FL43, FL44)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL45",
    title: "Install Vinyl Flooring and Trim – FL45",
    description: "Apply adhesive, install vinyl with minimal seams, seal edges, and replace fixtures/trim. Allow complete drying before traffic. (FL45, FL46, FL47, FL48)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
  ...
  {
    id: "FL49",
    title: "Inspect and Finalize Vinyl Installation – FL49",
    description: "Inspect vinyl for bubbles or loose areas, complete any corrections, pay installer, and get signed affidavit. (FL49, FL50, FL51, FL52)",
    tier1Category: "finishings",
    tier2Category: "flooring",
    category: "flooring",
    estimatedDuration: 2,
...
// Finishings Painting tasks
const paintingTasks: TaskTemplate[] = [
  {
    id: "PT1",
    title: "Plan Painting Requirements and Color Scheme – PT1",
    description: "Determine paint needs, select all colors/finishes for interior and exterior, create a paint schedule, and stage a mock-up wall for testing. (PT1, PT2, PT3, PT4)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
  },
  {
    id: "PT5",
    title: "Obtain Paint Bids and Select Contractor – PT5",
    description: "Conduct bidding process with painters, checking if they provide paint or just labor. Verify experience and availability. (PT5, PT6, PT7)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
  ...
  {
    id: "PT8",
    title: "Prepare Interior Surfaces for Painting – PT8",
    description: "Prepare all surfaces by patching, masking, priming, and filling nail holes. Ensure adequate ventilation. (PT8, PT9, PT10)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
  ...
  {
    id: "PT11",
    title: "Apply Interior Paint – PT11",
    description: "Apply multiple coats as needed (primer, sealer, base, top coat) to walls, ceilings, trim, and closets, using quality tools and techniques. (PT11, PT12, PT13, PT14)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
  ...
  {
    id: "PT15",
    title: "Verify Interior Paint Results – PT15",
    description: "Inspect all painted surfaces for missed spots, uneven coverage, or drips, and touch up as needed. (PT15, PT16)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
  ...
  {
    id: "PT17",
    title: "Complete Exterior Painting – PT17",
    description: "Wash and prep exterior surfaces, apply primer to raw wood, caulk gaps, and paint/stain according to schedule. (PT17, PT18, PT19, PT20)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
  ...
  {
    id: "PT21",
    title: "Finalize Painting Project – PT21",
    description: "Inspect all painted areas, make corrections, and pay painter (retaining final payment until all work is complete). (PT21, PT22, PT23)",
    tier1Category: "finishings",
    tier2Category: "painting",
    category: "painting",
    estimatedDuration: 2,
