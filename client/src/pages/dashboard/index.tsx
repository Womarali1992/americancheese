  ...
  return (
    <Layout>
      <div className="space-y-5 w-full max-w-full overflow-hidden px-1 sm:px-3">
        ...
        {/* Projects Overview */}
        <Card className="overflow-hidden border-slate-200 bg-white shadow-sm hover:shadow-md transition-all duration-200 rounded-xl relative border-l-4 border-l-blue-600">
          <CardHeader className="p-4 bg-gradient-to-r from-blue-600 to-blue-700 border-b border-blue-800">
            <div className="flex items-center justify-between">
              <CardTitle className="text-white font-medium">Projects Overview</CardTitle>
              {filteredProjects.length > 0 && (
                <div className="text-xs md:text-sm bg-blue-500 bg-opacity-25 text-white rounded-full px-2 md:px-3 py-1 font-medium border border-blue-500">
